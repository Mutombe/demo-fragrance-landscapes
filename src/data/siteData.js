...
const siteData = {
  business: {
    name: "Fragrance Landscapes",
    legalName: "Fragrance Landscapes",
    tagline: "Gardens That Engage Every Sense",
    description: "Fragrance Landscapes creates sensory-rich gardens that look beautiful, smell divine, and feel like private sanctuaries. We specialize in aromatic garden design and sustainable landscaping across Harare.",
    phone: "+263 77 700 4183",
    phoneRaw: "+263777004183",
    whatsappNumber: "263777004183",
    email: "fragrancelandscapes@gmail.com",
    address: "54WR+H9C, Corner Pringle Road, Harare Dr, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 3.9,
    ratingRounded: 4,
    ...
    cookieConsentKey: "fragrance-landscapes-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Fragrance", logoLine2: "Landscapes" },

  hero: {
    badge: "Sensory Garden Design Specialists",
    titleParts: [
      { text: "WHERE GARDENS " },
      { text: "COME", highlight: true },
      { text: " ALIVE." },
    ],
    subtitle: "300+ gardens designed. We create outdoor spaces that engage every sense -- lush textures you want to touch, blooms that perfume the air, and views that quiet the mind.",
  ...
  about: {
    ...
    story: [
      "Fragrance Landscapes was founded in 2018 by garden lovers who believed outdoor spaces should engage every sense. Based near Pringle Road in Harare, we specialize in aromatic garden design.",
      "Our approach combines fragrant plant selection with thoughtful spatial design, creating gardens that are not just beautiful to look at but therapeutic to experience.",
    ],
    values: [
    ...
    team: [
      { name: "The Founder", role: "Managing Director", bio: "With over a decade of industry experience, our founder built Fragrance Landscapes on a foundation of quality and trust.", image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&q=80" },
  ...
  contact: {
    ...
    branches: [
      { name: "Harare Office", address: "54WR+H9C, Corner Pringle Road, Harare Dr, Harare, Zimbabwe", phone: "+263 77 700 4183", email: "fragrancelandscapes@gmail.com" },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hello Fragrance Landscapes! I would like to discuss a project.",
    backgroundImage: "https://images.unsplash.com/photo-1558904541-efa843a96f01?w=1920&q=85",
  },

  footer: {
    description: "Fragrance Landscapes creates sensory-rich gardens that look beautiful, smell divine, and feel like private sanctuaries. ...",
    copyright: "Fragrance Landscapes",
  },
};
